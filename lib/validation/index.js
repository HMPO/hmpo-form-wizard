...
function applyValidator(validator, key, value, field) {
    ...
    let result = validator.fn.apply(this, [value].concat(validator.arguments));
...
function validate(fields, key, value) {
    ...
    _.find(
        field.validate,
        validator => err = applyValidator(validator, key, value, field)
    );
    return err;
}
